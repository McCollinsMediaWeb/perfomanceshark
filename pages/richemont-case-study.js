          ...
          <div className="row">
            <div className="col-md-7">
              ...
              <div className="Sec1T2 mrgB25">
                Drive enrollment to the Culinary Courses and get more leads to
                the UAE market.
              </div>
              <div className="Sec1T1">CHALLENGE</div>
              <div className="Sec1T2">
                Reach the right audience who have an interest in cooking
                Classes, Culinary Courses, and improving their cooking skills.
              </div>
            </div>
            <div className="col-md-5">
              ...
              >
                <Image
                  src="/clients/RicheMontCover.jpg"
                  layout="fill"
                  objectFit="cover"
                />
              </div>
